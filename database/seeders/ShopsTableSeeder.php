...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'img_url' => 'https://rese-bucket.s3.ap-northeast-1.amazonaws.com/shop_img/sushi.jpg',
        ];
        ...
        $param = [
            ...
            'img_url' => 'https://rese-bucket.s3.ap-northeast-1.amazonaws.com/shop_img/yakiniku.jpg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '戦慄',
            ...
            'img_url' => 'https://rese-bucket.s3.ap-northeast-1.amazonaws.com/shop_img/izakaya.jpg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => 'ルーク',
            ...
            'img_url' => 'https://rese-bucket.s3.ap-northeast-1.amazonaws.com/shop_img/italian.jpg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '志摩屋',
            ...
            'img_url' => 'https://rese-bucket.s3.ap-northeast-1.amazonaws.com/shop_img/ramen.jpg',
        ];
        DB::table('shops')->insert($param);
        $param = [
            'name' => '香',
